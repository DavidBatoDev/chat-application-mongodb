...
const Conversation = ({user, onClick}) => {
  ...
  return (
    <div className={`active:bg-slate-200 flex items-center px-5 py-3 gap-2 hover:bg-slate-200 ${darkMode && 'hover:bg-gray-900 active:bg-gray-900' } cursor-pointer`} onClick={onClick}>
